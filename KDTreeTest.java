...
public class KDTreeTest extends TestCase {
    ...
    public void setUp() {
        ...
        testCities = new City[] { new City("CityA", 50, 50), new City("CityB",
            ...
            new City("CityE", 90, 80), new City("CityF", 30, 40), new City(
                "CityG", 60, 60), new City("Origin", 0, 0), new City("MaxPoint",
                    100, 100) };
    }
    ...
    public void testTreeStructureIntegrity() {
        City[] orderedCities = { new City("Root", 50, 50), new City("LeftX", 25,
            60), new City("RightX", 75, 40), new City("LeftLeftY", 20, 30),
    ...
    public void testFuzzyRandomInsertDeleteSequence1() {
        int[][] coords = { { 500, 100 }, { 400, 200 }, { 600, 50 }, { 300,
            300 }, { 700, 25 }, { 350, 250 }, { 450, 150 }, { 250, 350 }, { 550,
                75 }, { 650, 40 } };
